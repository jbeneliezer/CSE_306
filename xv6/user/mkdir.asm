...
printint(int fd, int xx, int base, int sgn)
{
 ...
 310:	f7 f1                	div    %ecx
 312:	0f b6 92 b4 06 00 00 	movzbl 0x6b4(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 49a:	e9 06 ff ff ff       	jmp    3a5 <printf+0x45>
          s = "(null)";
 49f:	bb ab 06 00 00       	mov    $0x6ab,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 53c:	a1 28 09 00 00       	mov    0x928,%eax
 ...
 54b:	77 10                	ja     55d <free+0x2d>
{
 ...
 576:	89 08                	mov    %ecx,(%eax)
  freep = p;
 578:	a3 28 09 00 00       	mov    %eax,0x928
}
 57d:	5b                   	pop    %ebx
 57e:	5e                   	pop    %esi
 57f:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5b0:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5b3:	8b 15 28 09 00 00    	mov    0x928,%edx
 ...
 5db:	eb 70                	jmp    64d <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 5dd:	c7 05 28 09 00 00 2c 	movl   $0x92c,0x928
 5e4:	09 00 00 
 5e7:	c7 05 2c 09 00 00 2c 	movl   $0x92c,0x92c
 5ee:	09 00 00 
    base.s.size = 0;
 5f1:	c7 05 30 09 00 00 00 	movl   $0x0,0x930
 5f8:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5fb:	ba 2c 09 00 00       	mov    $0x92c,%edx
 ...
 60e:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 611:	89 15 28 09 00 00    	mov    %edx,0x928
      return (void*)(p + 1);
 ...
 632:	e8 f9 fe ff ff       	call   530 <free>
  return freep;
 637:	8b 15 28 09 00 00    	mov    0x928,%edx
      if((p = morecore(nunits)) == 0)
 ...
 64d:	89 c2                	mov    %eax,%edx
    if(p == freep)
 64f:	39 05 28 09 00 00    	cmp    %eax,0x928
