...
main(int argc, char *argv[])
{
  ...
  30:	ff 33                	pushl  (%ebx)
  32:	e8 91 02 00 00       	call   2c8 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 332:	f7 f1                	div    %ecx
 334:	0f b6 92 e8 06 00 00 	movzbl 0x6e8(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4d2:	e9 06 ff ff ff       	jmp    3dd <printf+0x49>
          s = "(null)";
 4d7:	bb df 06 00 00       	mov    $0x6df,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 572:	a1 5c 09 00 00       	mov    0x95c,%eax
 ...
 581:	77 10                	ja     593 <free+0x31>
{
 ...
 5ac:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ae:	a3 5c 09 00 00       	mov    %eax,0x95c
}
 5b3:	5b                   	pop    %ebx
 5b4:	5e                   	pop    %esi
 5b5:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5ea:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5ed:	8b 15 5c 09 00 00    	mov    0x95c,%edx
 ...
 615:	eb 72                	jmp    689 <malloc+0xb5>
    base.s.ptr = freep = prevp = &base;
 617:	c7 05 5c 09 00 00 60 	movl   $0x960,0x95c
 61e:	09 00 00 
 621:	c7 05 60 09 00 00 60 	movl   $0x960,0x960
 628:	09 00 00 
    base.s.size = 0;
 62b:	c7 05 64 09 00 00 00 	movl   $0x0,0x964
 632:	00 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 635:	b8 60 09 00 00       	mov    $0x960,%eax
 ...
 648:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 64b:	89 15 5c 09 00 00    	mov    %edx,0x95c
      return (void*)(p + 1);
 ...
 66e:	e8 ef fe ff ff       	call   562 <free>
  return freep;
 673:	8b 15 5c 09 00 00    	mov    0x95c,%edx
      if((p = morecore(nunits)) == 0)
 ...
 68b:	39 05 5c 09 00 00    	cmp    %eax,0x95c
